if (WITH_RANDOMX)
    add_definitions(/DMATRIX_ALGO_RANDOMX)
    set(WITH_ARGON2 ON)
    ...
    elseif (WITH_ASM AND NOT MATRIX_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    elseif (MATRIX_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    if (CMAKE_MX_COMPILER_ID MATCHES Clang)
    ...
    if (WITH_MSR AND NOT MATRIX_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8 AND (XMRIG_OS_WIN OR XMRIG_OS_LINUX))
        add_definitions(/DMATRIX_FEATURE_MSR)
        add_definitions(/DMATRIX_FIX_RYZEN)
        message("-- WITH_MSR=ON")
        ...
        remove_definitions(/DMATRIX_FEATURE_MSR)
        remove_definitions(/DMATRIX_FIX_RYZEN)
        message("-- WITH_MSR=OFF")
    endif()

    if (WITH_PROFILING)
        add_definitions(/DMATRIX_FEATURE_PROFILING)

        list(APPEND HEADERS_CRYPTO src/crypto/rx/Profiler.h)
        list(APPEND SOURCES_CRYPTO src/crypto/rx/Profiler.cpp)
    endif()
else()
    remove_definitions(/DMATRIX_ALGO_RANDOMX)
endif()
